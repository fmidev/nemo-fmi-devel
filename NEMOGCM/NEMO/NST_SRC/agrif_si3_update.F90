...
MODULE agrif_si3_update
   ...
   !! $Id: agrif_si3_update.F90 6204 2016-01-04 13:47:06Z cetlod $
...
# endif
   ...
   !!----------------------------------------------------------------------
CONTAINS
   SUBROUTINE agrif_si3_update_empty
      WRITE(*,*)  'agrif_si3_update : You should not have seen this print! error?'
   END SUBROUTINE agrif_si3_update_empty
#endif
