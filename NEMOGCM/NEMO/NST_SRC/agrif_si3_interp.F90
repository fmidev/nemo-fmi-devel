MODULE agrif_si3_interp
   ...
   !! $Id: agrif_si3_interp.F90 6204 2016-01-04 13:47:06Z cetlod $
...
!         ENDIF  ! nbghostcells=1
   ...
   !!----------------------------------------------------------------------
CONTAINS
   SUBROUTINE agrif_si3_interp_empty
      WRITE(*,*)  'agrif_si3_interp : You should not have seen this print! error?'
   END SUBROUTINE agrif_si3_interp_empty
#endif

   !!======================================================================
END MODULE agrif_si3_interp
