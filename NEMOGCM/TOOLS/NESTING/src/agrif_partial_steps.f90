...
CONTAINS
  ...
  SUBROUTINE check_interp( ParentGrid , gdepwChild )
    ...
    CALL correct_level( gdepwchild,ParentGrid,gdepw,e3t,1,2+nbghostcellsfine+connectionsize*irafx-1, &
         1,nyfin)
    ...
    CALL correct_level( gdepwchild,ParentGrid,gdepw,e3t,nxfin-1-nbghostcellsfine-(connectionsize*irafx-1),nxfin, &
         1,nyfin)
    ...
    CALL correct_level( gdepwchild,ParentGrid,gdepw,e3t,1,nxfin, &
         nyfin-1 - nbghostcellsfine -(connectionsize*irafy-1),nyfin )

    !
    ! south boundary
    !
    CALL correct_level( gdepwchild,ParentGrid,gdepw,e3t,1,nxfin, &
         1,2+nbghostcellsfine+connectionsize*irafy-1 )
